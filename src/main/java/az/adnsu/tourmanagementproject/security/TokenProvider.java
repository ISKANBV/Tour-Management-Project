...
public class TokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        Optional<az.adnsu.tourmanagementproject.domain.User> optionalUser = userRepository.findByUsername(claims.getSubject());

        if (optionalUser.isEmpty()) {
            return null;
        }

        az.adnsu.tourmanagementproject.domain.User user = optionalUser.get();
